...
Lumina.I18n.data = {
    zh: {
        ...
        pageModeHint: '进入听书模式',
        ttsVoiceHint: '提示：部分手机可能不支持在应用内切换音色，请到系统设置中切换',
        annotations: '注释',
        annotation: '注释',
        bookmark: '书签',
        storageDetails: '存储详情',
    ...
    zh1: {
        ...
        pageModeHint: '進入聽書模式',
        ttsVoiceHint: '提示：部分手機可能不支持在應用內切換音色，請到系統設置中切換',
        annotations: '註釋',
        annotation: '註釋',
        bookmark: '書籤',
        storageDetails: '儲存詳情',
    ...
    en: {
        ...
        ttsVoiceHint: 'Note: Some phones may not support switching voice in app, please switch in system settings',
