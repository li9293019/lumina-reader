...
Lumina.I18n.data = {
    zh: {
        ...
        autoConvertSC: '自动简繁转换', autoConvertSCDesc: '根据界面语言自动转换书籍简繁体',
        ...
        includeFonts: '包含字体文件', includeFontsDesc: '导出配置时包含自定义字体（会增加文件大小）',
        ...
        encrypting: '正在加密...', decrypting: '正在解密...', exporting: '正在导出...', exportingConfig: '正在匯出配置...', exportingConfig: '正在导出配置...',
        exportStep: '步骤 $1/$2$3',
        packingFonts: '打包字体',
        ...
        fontManagerAdd: '添加新字体', fontAddingInProgress: '正在导入字体，请稍候...',
        fontManagerLicenseNotice: '请确保您拥有字体的合法使用授权',
        termsTab: '用户协议', privacyTab: '隐私政策', legalInfo: '协议与政策', legalPageTitle: '欢迎使用流萤阅读器',
        legalAgreeLabel: '我已阅读并同意以上协议', startUsing: '同意并继续',
        declineExit: '不同意', mustAgreeToUse: '您需要同意协议才能使用本应用',
        declineExitMessage: '感谢理解，期待再次相见', thanksForUnderstanding: '感谢理解', closePageManually: '请手动关闭此页面',
        aboutVersion: '版本', aboutAuthor: '作者', aboutSupport: '支持', aboutSupportDesc: '喜欢流萤？请我喝杯咖啡。',
        aboutOpensource: '开源致谢', aboutOpensourceDesc: '本项目使用以下开源软件',
        aboutFonts: '字体致谢', aboutFontsDesc: '内置字体均为免费商用字体',
        aboutViewOnGithub: '在 GitHub 上查看', aboutSponsor: '打赏支持',
        aboutLastUpdate: '最后更新', externalLinkConfirm: '将访问阅读器外地址，是否跳转？\n\n$1',
    ...
    zh1: {
        ...
        autoConvertSC: '自動簡繁轉換', autoConvertSCDesc: '根據介面語言自動轉換書籍簡繁體',
        ...
        includeFonts: '包含字型檔案', includeFontsDesc: '匯出配置時包含自訂字型（會增加檔案大小）',
        ...
        encrypting: '正在加密...', decrypting: '正在解密...', exporting: '正在匯出...',
        exportStep: '步驟 $1/$2$3',
        packingFonts: '打包字型',
        ...
        fontManagerAdd: '添加新字體', fontAddingInProgress: '正在導入字體，請稍候...',
        fontManagerLicenseNotice: '請確保您擁有字體的合法使用授權',
        termsTab: '用戶協議', privacyTab: '隱私政策', legalInfo: '協議與政策', legalPageTitle: '歡迎使用流螢閱讀器',
        legalAgreeLabel: '我已閱讀並同意以上協議', startUsing: '同意並繼續',
        declineExit: '不同意', mustAgreeToUse: '您需要同意協議才能使用本應用',
        declineExitMessage: '感謝理解，期待再次相見', thanksForUnderstanding: '感謝理解', closePageManually: '請手動關閉此頁面',
        aboutVersion: '版本', aboutAuthor: '作者', aboutSupport: '支持', aboutSupportDesc: '喜歡流螢？請我喝杯咖啡。',
        aboutOpensource: '開源致謝', aboutOpensourceDesc: '本專案使用以下開源軟體',
        aboutFonts: '字型致謝', aboutFontsDesc: '內建字型均為免費商用字型',
        aboutViewOnGithub: '在 GitHub 上查看', aboutSponsor: '打賞支持',
        aboutLastUpdate: '最後更新', externalLinkConfirm: '將訪問閱讀器外地址，是否跳轉？\n\n$1',
    ...
    en: {
        ...
        autoConvertSC: 'Auto SC/TC Conversion', autoConvertSCDesc: 'Auto convert content based on UI language',
        ...
        includeFonts: 'Include Font Files', includeFontsDesc: 'Include custom fonts in config export (increases file size)',
        ...
        encrypting: 'Encrypting...', decrypting: 'Decrypting...', exporting: 'Exporting...', exportingConfig: 'Exporting config...',
        ...
        sectionRegexPlaceholder: 'Section regex', aggregateSearch: 'Aggregate Search',
        ...
        fontManagerAdd: 'Add New Font', fontAddingInProgress: 'Importing font, please wait...',
        fontManagerLicenseNotice: 'Please ensure proper font licensing',
        termsTab: 'User Agreement', privacyTab: 'Privacy Policy', legalInfo: 'Terms & Privacy', legalPageTitle: 'Welcome to Lumina Reader',
        legalAgreeLabel: 'I have read and agree to the above', startUsing: 'Agree & Continue',
        declineExit: 'Decline', mustAgreeToUse: 'You must agree to the terms to use this app',
        declineExitMessage: 'Thank you for your understanding', thanksForUnderstanding: 'Thank You', closePageManually: 'Please close this page manually',
        aboutVersion: 'Version', aboutAuthor: 'Author', aboutSupport: 'Support', aboutSupportDesc: 'Enjoying Lumina? Buy me a coffee.',
        aboutOpensource: 'Open Source', aboutOpensourceDesc: 'This project uses the following open source software',
        aboutFonts: 'Fonts', aboutFontsDesc: 'Built-in fonts are free for commercial use',
        aboutViewOnGithub: 'View on GitHub', aboutSponsor: 'Sponsor',
        aboutLastUpdate: 'Last Updated', externalLinkConfirm: 'This will open an external link. Continue?\n\n$1',
