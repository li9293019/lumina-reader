Lumina.I18n.data['en'] = {
    ...
    // 导出与加密
        ...
        defaultExportPassword: 'Default Export Password',
        defaultExportPasswordPlaceholder: 'Default export password (leave empty to prompt each time)',
    ...
    // 书库管理
        ...
        shareSelected: 'Share selected files',
        ...
        batchShareFailed: 'Share failed',
        shareSelectedTitle: 'Share Books',
        shareSelectedText: '$1 books from Lumina Reader',
        shareSelectedDialogTitle: 'Share with friends',
    ...
    // 批注与书签
        ...
        shareCardSettings: 'Reading Share Card',
        shareCardQualityStandard: 'Standard',
        shareCardQualityHigh: 'High',
        shareCardQualityUltra: 'Ultra',
        shareCardRoundedCorners: 'Use Rounded Corners',
        shareCardWatermark: 'Custom Watermark',
        shareCardWatermarkPlaceholder: 'Shared from Lumina Reader',
    ...
    // 运行时补充键
        ...
        romGuideOppo: 'ColorOS: Settings → Battery → App Power Management → Lumina Reader → Allow background activity',
        romGuideXiaomi: 'MIUI: Settings → Battery → App Battery Saver → Lumina Reader → No restrictions',
        romGuideHuawei: 'EMUI: Settings → Battery → App Launch → Lumina Reader → Allow background activity',
        romGuideVivo: 'OriginOS: Settings → Battery → Background Power Consumption → Lumina Reader → Allow high background power',
        romGuideSamsung: 'Samsung: Settings → Battery → Background usage limits → Lumina Reader → Unrestricted',
        romGuideTitle: 'Background Playback Tip',
        romGuideGeneric: 'If playback stops when screen is off, please allow this app to run in the background in system settings',
