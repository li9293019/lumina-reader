...
```
[2026-04-12T10:30:45.123Z] [INFO] [Database] 数据库初始化完成
[2026-04-12T10:30:46.456Z] [WARN] [Network] 请求超时，正在重试
[2026-04-12T10:30:47.789Z] [ERROR] [Import] 导入失败 | {"error":"文件格式错误"}
```
...
- **v1.0** (2026-04-12): 初始版本，支持文件日志和 console 拦截
